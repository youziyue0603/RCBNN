...
# 根据红框位置定义每个子图的簇中心位置和形状参数
fig_configs = [
    # Fig1: 左上角蓝色簇，右下角橙色簇，都是倾斜椭圆
    {
        'centers': [[-1.2, 0.8], [1.2, -0.8]],
        'shapes': [
            {'angle': np.pi / 6, 'stretch_x': 1.4, 'stretch_y': 0.8},  # 蓝色簇
            {'angle': np.pi / 6, 'stretch_x': 1.2, 'stretch_y': 0.9}  # 橙色簇
        ]
    },
    # Fig2: 上方橙色簇，下方蓝色簇，都是水平椭圆
    {
        'centers': [[0, 1.2], [0, -1.2]],
        'shapes': [
            {'angle': 0, 'stretch_x': 1.6, 'stretch_y': 0.7},  # 蓝色簇
            {'angle': 0, 'stretch_x': 1.8, 'stretch_y': 0.6}  # 橙色簇
        ]
    },
    # Fig3: 左上角橙色簇，右下角蓝色簇，倾斜椭圆
    {
        'centers': [[-1.0, 0.9], [1.3, -0.7]],
        'shapes': [
            {'angle': -np.pi / 8, 'stretch_x': 1.1, 'stretch_y': 0.9},  # 蓝色簇
            {'angle': -np.pi / 4, 'stretch_x': 1.5, 'stretch_y': 0.7}  # 橙色簇
        ]
    },
    # Fig4: 上方蓝色簇，下方橙色簇，水平椭圆
    {
        'centers': [[0, 1.0], [0, -1.0]],
        'shapes': [
            {'angle': 0, 'stretch_x': 1.7, 'stretch_y': 0.6},  # 蓝色簇
            {'angle': 0, 'stretch_x': 1.9, 'stretch_y': 0.5}  # 橙色簇
        ]
    },
    # Fig5: 左边橙色簇，右边蓝色簇，垂直椭圆
    {
        'centers': [[-1.3, 0], [1.3, 0]],
        'shapes': [
            {'angle': 0, 'stretch_x': 0.8, 'stretch_y': 1.4},  # 蓝色簇
            {'angle': 0, 'stretch_x': 0.7, 'stretch_y': 1.6}  # 橙色簇
        ]
    }
]

# 固定的簇标准差
fixed_cluster_std = 0.6
...
# 保存图片
plt.savefig('2.pdf', dpi=300, transparent=True, bbox_inches='tight')
plt.show()